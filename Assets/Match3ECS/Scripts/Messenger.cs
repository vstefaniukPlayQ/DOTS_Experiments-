...
//             }
        ...
        //Four parameters
        public static void AddListener<T, U, V, W>(string eventType, Action<T, U, V, W> handler)
        {
            OnListenerAdding(eventType, handler);
        ...
        public static void RemoveListener<T, U, V, W>(string eventType, Action<T, U, V, W> handler)
        {
            if (OnListenerRemoving(eventType, handler))
            {
                eventTable[eventType] = (Action<T, U, V, W>)eventTable[eventType] - handler;
        ...
        public static void Broadcast<T, U, V, W>(string eventType, T arg1, U arg2, V arg3, W arg4)
        {
            ...
            if (eventTable.TryGetValue(eventType, out d))
            {
                var callback = d as Action<T, U, V, W>;
        ...
        /// <summary>
        /// Broadcast with return value compatible with UnityMainThreadDispatcher.Instance().Enqueue.
        /// </summary>
        /// <param name="eventType"></param>
        /// <returns></returns>
        private static IEnumerator BroadcastAndYield(string eventType)
        {
            Broadcast(eventType);
            yield return null;
        }
        ...
        /// <returns></returns>
        private static IEnumerator BroadcastAndYield<T>(string eventType, T arg1)
        {
        ...
        /// <returns></returns>
        private static IEnumerator BroadcastAndYield<T, U>(string eventType, T arg1, U arg2)
        {
        ...
        /// <returns></returns>
        private static IEnumerator BroadcastAndYield<T, U, V>(string eventType, T arg1, U arg2, V arg3)
        {
            Broadcast<T, U, V>(eventType, arg1, arg2, arg3);
            yield return null;
        }

        private static IEnumerator BroadcastAndYield<T, U, V, W>(string eventType, T arg1, U arg2, V arg3, W arg4)
        {
            Broadcast<T, U, V, W>(eventType, arg1, arg2, arg3, arg4);
            yield return null;
        }
